...
<head>
  ...
  <title>Sistema de Agendamento de Consultas - Registrar-se</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href=""> <strong> Sistema de Agendamento de Consultas</strong> <br>Secretaria de Saúde de Itajuípe</a>
  </div>
    ...
    <div class="card-body register-card-body">
      ...
      <div class="form-group mb-3">
          <div class="form-group-text">
            <span class="fa fa-map-marker" aria-hidden="true"> Selecione o Posto de Saúde</span>
          </div>
        </div>
        <div class="input-group mb-3">
          <select name="empresa_id" id="" class = form-control>
            <option value="1" class = "form-control">Secretaria de Saúde de Itajuípe</option>
          </select>
