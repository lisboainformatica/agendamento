...
<head>
  ...
  <title>Sistema de Agendamento de Consultas de Itajuípe | Entrar</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""> <strong> Sistema de Agendamento de Consultas</strong> <br>Secretária de Saúde de Itajuípe</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
